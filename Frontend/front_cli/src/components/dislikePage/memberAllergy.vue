            ...
            <div v-for="(name, idx) in allergyList" :key="idx" class="col-4 checkAllergy">
              <label>
                <input
                  type="checkbox"
                  name="allergy"
                  @change="toggleAllergy(name)"
                  :checked="isAllergySelected(name)"
                />{{ name }}
              </label>
            </div>
          </div>
  ...
  data() {
    return {
      ...
      alleryNameToPk: {
        ...
        굴: [1930, 2315, 2817],
        "난류(가금류)": [
          1520, 1584, 1572, 1584, 1594, 1595, 1596, 1597, 1598, 1599, 1600, 1601, 1602, 1603, 1604,
          1605, 2775, 2783, 2784, 2785, 2786, 2787, 2788, 2789, 2790,
        ],
        닭고기: [
        ...
        대두: [86, 87, 2142, 2580],
        돼지고기: [
          1346, 1347, 1348, 1374, 1375, 1376, 1377, 1378, 1379, 1380, 1381, 1382, 1383, 1384, 1385,
          1386, 1387, 1388, 1389,
        ],
        땅콩: [116, 126, 127, 2159],
        ...
        쇠고기: [
          1278, 1279, 1280, 1329, 1330, 1331, 1332, 1333, 1334, 1335, 1336, 1337, 1338, 1339, 1340,
          1341, 1342, 1343, 1344, 1345, 2923, 2924,
        ],
        "아황산 포함식품": [
          290, 291, 369, 404, 435, 436, 460, 471, 472, 474, 475, 477, 478, 479, 480, 493, 522, 2222,
          2474, 2475, 2476, 2477, 2478, 2479, 2756, 2969,
        ],
